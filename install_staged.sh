...
install_codemirror() {
    ...
    rm -rf $BUILD/CodeMirror $BUILD/CodeMirror-Extension
...
if [ ! -f $BUILD/.install_ghc ]; then
    install_ghc
    touch $BUILD/.install_ghc
fi

if [ ! -f $BUILD/.install_cabal_install ]; then
    install_cabal_install
    touch $BUILD/.install_cabal_install
fi

if [ ! -f $BUILD/.install_happy_alex ]; then
    install_happy_alex
    touch $BUILD/.install_happy_alex
fi

if [ ! -f $BUILD/.install_ghcjs ]; then
    install_ghcjs
    touch $BUILD/.install_ghcjs
fi

if [ ! -f $BUILD/.install_codemirror ]; then
    install_codemirror
