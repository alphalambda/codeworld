...
inventory = blank
  & translated(labels(tangramL,[-1,-1,1]) & solidBlock(tangramL,red),-7.5,7)
  & translated(minitext("2 tangramL"),-7.5,5.5)
  & translated(labels(tangramS,[-1,-1,1]) & solidBlock(tangramS,red), 8,7)
  & translated(minitext("2 tangramS"),8,5.5)
  & translated(labels(tangramM,[-1,-1,1]) & solidBlock(tangramM,red),0,8)
  & translated(minitext("1 tangramM"),-1,6.5)
  & translated(labels(tangramD,[-1,-1,1,1]) & solidBlock(tangramD,red), 8,-6.5)
